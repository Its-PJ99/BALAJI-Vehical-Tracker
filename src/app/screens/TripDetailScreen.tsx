...
export default function TripDetailScreen() {
  ...
  const activeCheckpoint = trip.checkpoints.find((cp) => cp.status === 'active');
        ...
        <div className="max-w-2xl mx-auto px-4 py-4">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="flex-1">
              <h1 className="text-xl font-semibold text-foreground">{trip.vehicleNumber}</h1>
            </div>
        ...
        <div className="max-w-2xl mx-auto px-4 py-4">
          <div className="grid grid-cols-3 gap-4 text-center">
            <div>
              ...
              <p className="text-lg font-semibold text-foreground">{trip.remainingKm} KM</p>
            </div>
            <div>
              ...
              <div className="w-full bg-muted rounded-full h-1.5 mt-2">
                <div
                  ...
                  style={{ width: `${(trip.coveredKm / trip.totalKm) * 100}%` }}
                />
              </div>
            </div>
            <div>
